...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/controller: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/controller ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/LoadingRender.o: LoadingRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LoadingRender.o LoadingRender.cpp

${OBJECTDIR}/MainRender.o: MainRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MainRender.o MainRender.cpp
...
${OBJECTDIR}/SettingsRender.o: SettingsRender.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SettingsRender.o SettingsRender.cpp
