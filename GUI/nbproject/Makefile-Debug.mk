...
# CC Compiler Flags
CCFLAGS=`pkg-config --cflags --libs sfml-all` -std=c++11 
CXXFLAGS=`pkg-config --cflags --libs sfml-all` -std=c++11 
...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/controller: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/controller ${OBJECTFILES} ${LDLIBSOPTIONS} `pkg-config --cflags --libs glu gl` -std=c++11
